...
const people = [
  ...
  { srcImage: "/images/icon/romania.png", name: "Romanian" },
  { srcImage: "/images/icon/ukraine.png", name: "Ukrainian" },
  { srcImage: "/images/icon/Bangladesh.png", name: "Bengali" },
  { srcImage: "/images/icon/india.png", name: "Hindi" },
  { srcImage: "/images/icon/nepal.png", name: "Nepali" },
  { srcImage: "/images/icon/srilanka.png", name: "Sinhala" },
  { srcImage: "/images/icon/pakistan.png", name: "Urdu" },
  { srcImage: "/images/icon/zambia.png", name: "Bemba" },
  { srcImage: "/images/icon/niger.png", name: "Hausa" },
  { srcImage: "/images/icon/malawi.png", name: "Chichewa" },
];
