...
export default function TopSquash() {
    return (
                                                            ...
                                                            <div className="top_matches__clubname">
                                                                <div
                                                                    ...
                                                                    <div className="d-flex align-items-center gap-1">
                                                                        <Image src="/images/icon/squash.png" width={16} height={16}
                                                                            alt="Icon" /> <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                            ...
                                                                            <Image className="rounded-5" src="/images/icon/squash-2.png" width={24} height={24}
                                                                                alt="Icon" /> <span
