...
import { norwayData } from "@/../public/data/allPageData";

export default function TopBandy() {
    return (
                            ...
                            <div className="row w-100 pt-md-5">
                                <div className="col-12">
                                    <div className="top_matches__title d-flex align-items-center gap-2 mb-4 mb-md-5">
                                        <Image src="/images/icon/poland2.png" width={30}
                                            height={30} alt="Icon" />
                                        <h3>Norway</h3>
                                    </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                            ...
                                                                            <Image className="rounded-5" src="/images/icon/bandy2.png" width={24} height={24}
                                                                                alt="Icon" /> <span
                                                                                    className="fs-seven cpoint">{clubNameOne}</span>
                                                                        </div>
                                                                        <div className="d-flex align-items-center gap-2">
                                                                            <Image className="rounded-5" src="/images/icon/ac-brive.png" width={24} height={24}
                                                                                alt="Icon" /> <span
