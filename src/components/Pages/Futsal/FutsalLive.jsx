...
import { poland } from "@/../public/data/allPageData";


export default function FutsalLive() {
  return (
              ...
              <div className="row w-100 mb-4 mb-md-6">
                <div className="col-12">
                  <div className="top_matches__title d-flex align-items-center gap-2 mb-4 mb-md-6">
                    <Image src="/images/icon/poland2.png" width={32}
                      height={32} alt="Icon" />
                    <h3>Poland</h3>
                  </div>
                                ...
                                <div
                                  ...
                                  <div className="d-flex align-items-center gap-1">
                                    <Image src="/images/icon/futsal.png" width={16} height={16} alt="Icon" /> <span
                                      className="fs-eight cpoint">Poland Ekstraklasa</span>
                                  </div>
                                  <div
                                    className="d-flex align-items-center gap-4 pe-xl-15 flex-nowrap flex-xl-wrap">
                                    <span className="fs-eight cpoint me-xl-6">In 2 days,
                                      00:00</span>
                                  </div>
                                </div>
                                <div
                                  ...
                                  <div>
                                    <div className="d-flex align-items-center gap-2 mb-4">
                                      <Image className="rounded-5"
                                        src="/images/icon/futsal-league.png" width={24} height={24}
                                        alt="Icon" /> <span className="fs-seven cpoint">{clubNameOne}</span>
                                    </div>
