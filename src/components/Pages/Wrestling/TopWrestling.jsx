...
import { njpwData } from "@/../public/data/allPageData";

export default function TopWrestling() {
    return (
                                                            ...
                                                            <div className="top_matches__clubname">
                                                                <div
                                                                    ...
                                                                    <div className="d-flex align-items-center gap-1">
                                                                        <Image src="/images/icon/wrestling.png" width={16} height={16}
                                                                            alt="Icon" /> <span
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                            ...
                                                                            <Image className="rounded-5" src="/images/icon/germany.png" width={16} height={16}
                                                                                alt="Icon" /> <span
                                                                                    className="fs-seven cpoint">{clubNameOne}</span>
                                                                        </div>
                                                                        <div className="d-flex align-items-center gap-2">
                                                                            <Image className="rounded-5" src="/images/icon/mazaud.png" width={16} height={16}
                                                                                alt="Icon" /> <span
